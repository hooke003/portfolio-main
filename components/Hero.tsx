...
const Hero: React.FC = () => {
  ...
  const renderSpotlights = useCallback(
    () => (
      <div
        className="spotlight-container absolute inset-0 overflow-hidden"
        aria-hidden="true"
      >
  ...
  return (
    <section
      className="relative overflow-hidden min-h-screen flex items-center justify-center py-20"
    ...
    >
      ...
      <div className="relative z-10 max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] text-center">
        <header>
          <p
            className="uppercase tracking-widest text-xs text-blue-100 mb-4"
            aria-hidden="true"
          >
